...
- **Backend:** Node.js (Fastify) or Python (FastAPI), PostgreSQL, S3-compatible storage.
...
- **TODO:** Set up the frontend scaffold (Vite + React).
- **TODO:** Set up the backend scaffold and database migrations.
- **TODO:** Implement the CLI tool.
